...
public class GroupsTable {
    ...
    public static final int COLUMNS_NUM_CREATED_AT = 9;
    public static final int COLUMNS_NUM_EXP_AT = 10;
    public static final int COLUMNS_NUM_IS_RUNNING = 11;
    public static final int COLUMNS_NUM_IS_FINISHED = 12;
    public static final int COLUMNS_NUM_FINISHED_AT = 13;
