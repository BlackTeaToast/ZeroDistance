...
public class GroupsTable {
    ...
    public static final int COLUMNS_NUM_NEED_NUM = 4;
    public static final int COLUMNS_NUM_CURRENT_NUM = 5;
    public static final int COLUMNS_NUM_PLACE = 6;
    public static final int COLUMNS_NUM_CONTENT = 7;
    public static final int COLUMNS_NUM_CREATED_AT = 8;
    public static final int COLUMNS_NUM_EXP_AT = 9;
    public static final int COLUMNS_NUM_IS_RUNNING = 10;
    public static final int COLUMNS_NUM_IS_FINISHED = 11;
    public static final int COLUMNS_NUM_FINISHED_AT = 12;
